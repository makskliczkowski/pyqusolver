...
class TestLearningPhaseDataclass:
    ...
    def test_learning_rate_decay(self):
        ...
        phase = LearningPhase(
            name="decay_test", epochs=100, learning_rate=0.1, lr_decay=0.95, lr_min=1e-5
        )
    ...
    def test_regularization_schedules(self):
        ...
        for sched in schedules:
            phase = LearningPhase(
                name=f"reg_{sched}", epochs=100, regularization=0.01, reg_schedule=sched
            )
...
class TestCallbackFunctionality:
    ...
    def test_callbacks_are_callable(self):
        ...
        phase = LearningPhase(
            name="test", epochs=5, on_phase_start=callback1, on_phase_end=callback2
        )
...
class TestEdgeCases:
    ...
    def test_zero_decay_learning_rate(self):
        ...
        phase = LearningPhase(
            name="constant_lr", epochs=10, learning_rate=0.1, lr_decay=1.0  # No decay
        )
    ...
    def test_very_small_regularization(self):
        ...
        phase = LearningPhase(
            name="small_reg", epochs=10, regularization=1e-10, reg_schedule="constant"
        )
