...
try:
    from QES.general_python.algebra.utils import backend_mgr, JAX_AVAILABLE, Array
    ...
    raise ImportError("Failed to import necessary modules for backend_ops testing. Ensure QES package is correctly installed.") from e
