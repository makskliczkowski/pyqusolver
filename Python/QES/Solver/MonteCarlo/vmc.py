...
class VMCSampler(Sampler):
        ...
        try:
             ...
             if isinstance(upd_rule, (str, Enum)):
                  ...
                  if upd_rule == UpdateRule.LOCAL:
                       ...
                       return partial(propose_worm_flip_with_info, neighbor_table=neighbor_table, length=length)
    ...
    def _sweep_chain(self, chain, logprobas, rng_k, num_proposed, num_accepted, params, update_proposer, log_proba_fun, accept_config_fun, net_callable_fun, steps):
        ...
        return self._run_mcmc_steps_np(chain, logprobas, num_proposed, num_accepted, params, rng_k, steps, self._mu, self._beta, use_update_proposer, use_log_proba_fun, use_accept_config_fun, use_net_callable_fun)
    ...
    @staticmethod
    def _generate_samples_jax(states_init, logprobas_init, rng_k_init, num_proposed_init, num_accepted_init, params,
        num_samples, total_therm_updates, updates_per_sample, mu, beta, update_proposer, net_callable_fun, log_psi_delta_fun=None):
    ...
    @staticmethod
    def _static_sample_jax(states_init, rng_k_init, num_proposed_init, num_accepted_init, params,
            num_samples, num_chains, total_therm_updates, updates_per_sample, shape, mu, beta, logprob_fact,
            update_proposer, net_callable_fun, log_psi_delta_fun=None):
    ...
    def _static_sample_pt_jax(
            states_init, rng_k_init, num_proposed_init, num_accepted_init, params,
            num_samples, num_chains, n_replicas, total_therm_updates, updates_per_sample, shape, mu, pt_betas, logprob_fact,
            update_proposer, net_callable_fun, log_psi_delta_fun=None):
        ...
        def therm_scan_body(carry, _):
            ...
            states_new, lpsi_new, keys_new, n_prop_new, n_acc_new = vmapped_mcmc_step(states, lpsi, replica_keys, n_prop, n_acc, betas)
        ...
        initial_carry   = (states_init, logprobas_init, rng_k_init, num_proposed_init, num_accepted_init, current_betas)
    ...
    def sample(self, parameters=None, num_samples=None, *, num_chains=None, num_therm=None, betas=None):
        ...
        if used_num_chains != self._numchains or used_num_samples != self._numsamples or used_num_therm != self._therm_steps:
            if self._logger: self._logger.info(f"(Warning) Running sample with {used_num_chains} chains (instance default is {self._numchains}). State reinitialized for this call.")
    ...
    def get_therm_steps(self): return self._therm_steps
    def get_sweep_steps(self): return self._sweep_steps
    ...
    def get_pt_betas(self): return self._pt_betas
    def get_pt_n_replicas(self): return self._n_replicas
