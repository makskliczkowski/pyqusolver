...
try:
    ...
    from QES.Algebra.Operator.operator import OperatorFunction, OperatorTypeActing
    ...
    def build(self, verbose: bool = False, use_numpy: bool = True, force: bool = False):
        ...
        if self._is_manybody:
            ...
            if (
                ...
                self._log(
                    "Local energy functions not set, attempting to set them via _set_local_energy_operators...",
                    lvl=2,
                    log="debug",
                )
                try:
