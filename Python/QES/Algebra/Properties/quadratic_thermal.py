...
def fermi_grand_potential(epsilon: Array, beta: float, mu: float = 0.0) -> float:
    """
...
def fermi_particle_number(epsilon: Array, beta: float, mu: float = 0.0) -> float:
    """
...
def fermi_internal_energy(epsilon: Array, beta: float, mu: float = 0.0) -> float:
    """
...
def fermi_heat_capacity(epsilon: Array, beta: float, mu: float = 0.0) -> float:
    """
...
def bose_grand_potential(epsilon: Array, beta: float, mu: float = 0.0) -> float:
    """
