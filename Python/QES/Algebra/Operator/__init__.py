...
_OPERATOR_TYPES = {
    'operators_spin': [
        'sig_x', 'sig_y', 'sig_z',      # Pauli matrices
        'sig_plus', 'sig_minus',        # Raising/lowering
        'make_sigma_mixed',             # Mixed correlators (e.g., sigma_x_i sigma_y_j)
    ],
    'operators_spin_1': [
        's1_x', 's1_y', 's1_z',         # Spin-1 matrices
        's1_plus', 's1_minus',          # Raising/lowering (S_+, S_-)
        's1_squared',                   # S^2 operator
        's1_xy', 's1_yx', 's1_xz',      # Two-site correlators
        's1_zx', 's1_yz', 's1_zy',      # Two-site correlators
    ...
    'operators_hardcore': [
        'b', 'b_dag', 'n_hc',           # Hardcore boson operators
    ],
    'phase_utils': [
