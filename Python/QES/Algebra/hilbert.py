...
try:
    ...
    #################################################################################################
    from QES.Algebra.Hilbert.hilbert_local          import LocalSpace, StateTypes, HilbertBasisType
...
class HilbertSpace(BaseHilbertSpace):
    ...
    def __init__(self,
        ...
        **kwargs:
        ...
        super().__init__(ns, lattice, _local_space, backend, state_type, dtype, logger=logger, 
