...
class TDVPAutoTuner:
    ...
    def __init__(self, config: AutoTunerConfig = None, logger=None):
        ...
        self.history = {"energy": [], "variance": [], "lr": [], "diag": [], "samples": []}
    ...
    def update(
        self, step_info, diagnostics: Dict[str, float], current_energy: float
        ...
        return (
            {"lr": self.lr, "diag_shift": self.diag_shift, "n_samples": self.n_samples},
            accepted,
            warnings,
        )
