"""DQMC stability and extraction smoke tests."""
...
def test_udt_stability():
    ...
    # Moderate conditioning: stable and naive should agree directly.
    ...
    # Strong conditioning: compare inverse residual quality, not raw entrywise
    # equality to the naive inverse.
...
def test_hubbard_dqmc_model_extraction():
    ...
    assert K.shape == (4, 4)
    # Check nearest-neighbor hopping on the 2x2 periodic square lattice.
