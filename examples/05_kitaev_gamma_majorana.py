"""
Kitaev-Gamma-Majorana Model Example
===================================

This example demonstrates how to:
1. Create a Honeycomb lattice.
2. Initialize the Kitaev-Gamma-Majorana model (non-interacting Majorana fermions).
3. Explicitly control the basis (Real space vs K-space).
4. Perform basis transformations and diagonalization.

To run:
    python examples/05_kitaev_gamma_majorana.py
"""
...
def main():
    ...
    # Create HilbertSpace with explicit basis
